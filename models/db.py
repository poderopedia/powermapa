...
db.define_table('Organizacion',
    ...
    Field('tipoOrg',db.tipoOrganizacion, requires=IS_IN_DB(db,'tipoOrganizacion.id','tipoOrganizacion.name'),
    ...
    Field('Mainsector','list:reference sector', label=T('Main Sector'),
          requires = IS_IN_DB(db,'sector.id','db.sector.name',multiple=True)),
    ...
    Field('longBio','text', requires=IS_LENGTH(65536),label='Perfil largo',widget=ckeditor.widget),
